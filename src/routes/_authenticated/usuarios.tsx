...
type Papel = "master" | "gestor" | "usuario";
...
export const Route = createFileRoute("/_authenticated/usuarios")({
  head: () => ({
    meta: [
      { title: "Usuários | Prospectar360" },
      { name: "description", content: "Crie usuários, defina papéis e vincule cada pessoa às suas unidades." },
      { property: "og:title", content: "Usuários | Prospectar360" },
      { property: "og:description", content: "Crie usuários, defina papéis e vincule cada pessoa às suas unidades." },
    ],
  }),
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Cada pessoa vê somente os dados das unidades vinculadas. O master vê todas.
        </p>
      </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            <Label>Unidades do novo usuário</Label>
            <div className="flex flex-wrap gap-3">
              ...
              {unidades.length === 0 ? (
                <span className="text-sm text-muted-foreground">Cadastre uma unidade primeiro.</span>
              ) : null}
            </div>
          </div>
        </CardContent>
                    ...
                    <TableCell>
                      {u.id === me?.userId ? (
                        <Badge variant="secondary" className="gap-1">
                          <ShieldCheck className="h-3 w-3" /> {PAPEL_LABEL[u.papel]}
                        </Badge>
                      ) : (
                        <Select
                          value={u.papel}
